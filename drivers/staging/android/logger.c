...
DEFINE_LOGGER_DEVICE(log_main, CONFIG_LOGCAT_SIZE*1024)
DEFINE_LOGGER_DEVICE(log_events, CONFIG_LOGCAT_SIZE*1024)
DEFINE_LOGGER_DEVICE(log_radio, CONFIG_LOGCAT_SIZE*1024)
DEFINE_LOGGER_DEVICE(log_system, CONFIG_LOGCAT_SIZE*1024)
DEFINE_LOGGER_DEVICE(log_sf, CONFIG_LOGCAT_SIZE*1024)
